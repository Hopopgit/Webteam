...
//mail server testing starts
 ...
 $params = array(
      ...
      'html' => 'You have received a new message from your website contact form.Here are the details:<br>Email:  '.$email,
      'text' => 'You have received a new message from your website contact form.Here are the details:Email:'.$email,
      'from' => $email,
   );
